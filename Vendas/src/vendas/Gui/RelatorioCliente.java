...
public class RelatorioCliente extends JPanel {
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                RelatorioCliente.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                RelatorioCliente.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                RelatorioCliente.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                RelatorioCliente.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<vendas.Gui.Clientes> toRemove = new ArrayList<vendas.Gui.Clientes>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            vendas.Gui.Clientes c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        vendas.Gui.Clientes c = new vendas.Gui.Clientes();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<vendas.Gui.Clientes> merged = new ArrayList<vendas.Gui.Clientes>(list.size());
            for (vendas.Gui.Clientes c : list) {
    ...
    private java.util.List<vendas.Gui.Clientes> list;
    ...
    public  void main() {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new RelatorioCliente());
